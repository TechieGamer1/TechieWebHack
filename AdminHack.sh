...
echo -e "                 \t${bd}${g}╭${w} Author  ${b}:${c} ${ul}Techie Gamer${n}          ${g}${n}"
echo -e "                 \t${bd}${g}│${w} Telegram ${b}:${w} @TechieGamer                          ${g}${n}"
echo -e "                 \t${bd}${g}│${w} Insta    ${b}:${w} @dhruv_choudhary_08                   ${g}${n}"
echo -e "     \t${bd}${g} ╭──────────────┴${w} Date    ${b}:${w} 31/03/2023                 ${g}${n}"
}
